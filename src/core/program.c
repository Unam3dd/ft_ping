...
/* Returns 0 when at least one reply came back, 1 when the host answered
 * nothing, and PING_FATAL when the host could not even be set up (the
 * caller then stops, like inetutils does on an unknown host). */
